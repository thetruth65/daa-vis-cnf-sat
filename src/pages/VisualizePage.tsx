...
// import TruthTableVisualizer from '../components/TruthTableVisualizer.tsx'; // <-- NEW IMPORT
// import {
...
//   return (
//     // --- UPDATED: Container is now full-width with padding ---
...
//             {/* --- THE NEW, FINAL DASHBOARD LAYOUT --- */}
...
//                             </Box>
//                             <Box sx={{ width: { xs: '100%', xl: '50%' } }}>
//                                <TruthTableVisualizer formula={formula} assignment={currentScFrame.currentAssignment} literalResults={currentScFrame.literalResults} clauseResults={currentScFrame.clauseResults} animationStep={currentScFrame.step} />
//                             </Box>
//                           </Box>
...
//                               </Box>
//                               <Box sx={{ width: { xs: '100%', xl: '50%' } }}>
//                                 <TruthTableVisualizer formula={formula} assignment={currentBfFrame.currentAssignment} literalResults={currentBfFrame.literalResults} clauseResults={currentBfFrame.clauseResults} animationStep={currentBfFrame.step} />
//                               </Box>
//                             </Box>
